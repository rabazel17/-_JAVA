...
public class BookingView implements View {
    ...
    public void showReservationStatus(int reservationNo) {
        if (reservationNo > 0){
            ...
            System.out.println("Ошибка бронирования cтолика.");
        }
    }

    public void newReservationStatus(int newReservationNo){
        if (newReservationNo > 0) {
            System.out.printf("Новый столик успешно забронирован. Номер брони: #%d\n", newReservationNo);
        } else {
            System.out.println("Ошибка бронирования толика.");
